                    ...
                    <div className="container">
                        <div className="banner_content text-left">
                            <Reveal effect="fadeInUp" duration={1500}>
                                <h2 className="wow fadeInLeft animated">Hi, I'm Dipesh Arya</h2>
                            </Reveal>
                            <Reveal effect="fadeInUp" duration={2200}>
                                <h4 className="wow fadeInUp anoimated cursor">{name} &zwnj;</h4>
                            </Reveal>
                            <div className="banner_para"><p>I'm currently a computer science and enginnering btech undergraduate at Amity University Mumbai.</p></div>
                        </div>
                    </div>
                )}
            </WaterWave>
